...
- **Modular** — numbered drop-ins under `config/shell/{core,zsh,conf.d}`, each
  individually toggleable with `dotfiles disable <name>`.
...
them with your own. Do not copy secrets, tokens, or untracked `*.local` files.
